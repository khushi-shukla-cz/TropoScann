...
// Map event handler with smooth animations
        ...
        {locations.map((location, index) => (
          <React.Fragment key={`area-${index}`}>
            <Circle
              ...
              pathOptions={{
                color: location.riskLevel === 'high' ? '#dc2626' : 
                       location.riskLevel === 'moderate' ? '#ea580c' : '#059669',
                fillColor: location.riskLevel === 'high' ? '#dc2626' : 
                          location.riskLevel === 'moderate' ? '#ea580c' : '#059669',
                fillOpacity: 0.1,
                weight: 2,
                opacity: 0.6
